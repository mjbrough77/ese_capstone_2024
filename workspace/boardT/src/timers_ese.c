/**
  ...
  *@brief Function definitions for hardware timers and sensors making use of
  *        hardware timers
  *
  *@version 1.0
  *@date 2024-04-09
...
_Noreturn void ultrasonic_data_task(void* param){
    ...
    while(1){
        ...
        /* obstacle close enough to slow wheelchair */
        ...
        /* obstacle close enough to stop wheelchair */
